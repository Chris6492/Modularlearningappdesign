...
courses = [
    {
        ...
        "lessons": [
            ...
            },
            {
                ...
                "activities": ["Analyze tokenization outputs", "Compare embedding distances"],
                "completed": False
            },
            {
                "id": "1-1-3",
                ...
                "activities": ["Practice CoT prompts", "Implement flipped interactions"],
                "completed": False
            },
            {
                "id": "1-2",
                ...
                "objectiveDetails": {
                    ...
                    "Bad Prompting and Lack of Context": {
                        ...
                        "description": "Bad prompting and lack of context can significantly reduce the effectiveness of AI assisted coding. When prompts are vague or incomplete, AI tools may generate incorrect or inefficient code. Providing clear, detailed prompts is critical for aligning AI output with requirements."
                    },
                    "Over-Reliance": {
                        "title": "Skill Erosion Risks",
                        "description": "Overreliance occurs when developers depend too heavily on AI without critical oversight. This can lead to accepting inefficient code and weakening core skills like debugging and system design. Maintaining human judgment is vital for long-term project health."
                    },
                    "Licensing & ip risk": {
                        "title": "Legal Compliance",
                        "description": "Using AI tools introduces intellectual property risks. Proprietary code shared with external AI systems can lead to data leakage. Organizations must ensure AI outputs comply with open source licenses and internal standards."
                    }
                },
                "activities": ["Review AI code for hallucinations", "Identify missing context in prompts"],
                "completed": False
            },
            {
                "id": "1-3",
                ...
                "objectiveDetails": {
                    "Master the Context-Action-Result structure": {
                        "title": "C.A.R. Framework",
                        "description": "The C.A.R. Prompting Method (Context → Action → Result) is a practical framework developers use to unlock senior-level thinking. Context frames the problem and constraints. Action specifies the exact steps for the AI. Result defines the expected quality and educational outcomes."
                    },
                    "Senior Level Prompts Workflow": {
                        "title": "Developer Workflow",
                        "description": "Daily routines like Context Sync, Requirement Clarification, and Failure-First Testing ensure AI is used strategically. This includes using AI for self-code review to level up skills and identifying technical debt early."
                    }
                },
                "exampleType": "carPrompt",
                "activities": ["Create a C.A.R. prompt", "Perform an AI-assisted code review"],
                "completed": False
            },
            {
                "id": "1-4",
                ...
                "duration": "20 min",
                "content": "Overview of major AI tools and IDEs.",
                "objectives": [
                ...
                "objectiveDetails": {
                    "Learning the core capabilities of each AI Tool": {
                        ...
                        "description": "Exploration of Google Antigravity (agent-first IDE), Anthropic Claude (reliable production code), Google Gemini (multimodal understanding), and OpenAI GPT (broad integration)."
                    }
                },
                "activities": ["Compare Claude vs GPT outputs", "Test Gemini's context window"],
                "completed": False
            }
        ]
    }
